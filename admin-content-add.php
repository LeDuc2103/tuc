...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $tacgia = isset($_SESSION['user_name']) ? mysql_real_escape_string($_SESSION['user_name']) : 'Quản lý';
    $sql_insert = "INSERT INTO baiviet (TieuDe, NoiDung, NgayDang, TacGia) VALUES ('$tieude', '$noidung', NOW(), '$tacgia')";
    if (mysql_query($sql_insert, $conn)) {
        header('Location: admin-content.php?msg=add_success');
        exit;
    } else {
        $msg = '<div class=\'alert alert-danger\'>Thêm bài viết thất bại!</div>';
    }
}
?>
<!DOCTYPE html>
...
<div class="container" style="margin-top:40px;max-width:700px;">
    ...
    <form method="post">
        ...
        <div class="form-group">
            ...
            <textarea name="noidung" class="form-control" rows="8" required></textarea>
        </div>
