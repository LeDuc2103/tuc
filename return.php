...
<!-- Mirrored from jthemes.net/themes/f-html/vetrov/return.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Apr 2025 02:25:34 GMT -->
<head>
        <meta charset="utf-8">
                                ...
                                <table class="product-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="image">
                                                <div class="white-bg">
                                                    <a class="media-link" href="#"><img src="/assets/images/gallery/80x80-1.jpg" alt=""></a> 
                                                </div>
                                            </td>
                                            <td class="description">
                                                <p>
                                                    <a href="#">
                                                        <span class="sub-title-2"> 1120 REVEW </span> 
                                                        <span class="rating">
                                                ...
                                                <h3 class="title-3 no-margin"> <a href="#"> Gran Hotel de Mexico. </a> </h3>
                                                <h6>HOTELS</h6>                                                                                                                             
                                            </td>
                                            <td> 
