<?php
include_once 'controllers/OrderHistoryController.php';
?>
<!DOCTYPE html>
...
<!-- Mirrored from jthemes.net/themes/f-html/vetrov/order-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Apr 2025 02:25:34 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body id="home" class="wide">
        ...
        <main class="wrapper"> 
            ...
            <article class="home-three">
                ...
                <!-- My Account Starts-->
                <section class="account-page sec-space-top pb-70">
                    <div class="container"> 
                        ...
                        <div class="cart-table">
                            <form class="cart-form">
                                <table class="product-table">
                                    ...
                                    <?php if ($orders && count($orders) > 0): ?>
                                        ...
                                        <tr>
                                            <td class="image">
                                                <div class="white-bg">
                                                    <a class="media-link" href="tour-detail.php?id=<?php echo $order['MaTour']; ?>"><img src="assets/images/tour/<?php echo htmlspecialchars($order['HinhAnh']); ?>" alt=""></a> 
                                                </div>
                                            </td>
                                            <td class="description">
                                                <h3 class="title-3 no-margin"> <a href="tour-detail.php?id=<?php echo $order['MaTour']; ?>"> <?php echo htmlspecialchars($order['TenTour']); ?> </a> </h3>
                                            </td>    
                                            <td> 
                                                <div class="price fontbold-2"> 
                                                    <strong class="fsz-20"><?php echo number_format($order['TongGia'],0,',','.'); ?> VNĐ</strong> 
                                                </div>
                                            </td> 
                                            <td> 
                                                <div class="text-center pt-20"> <b class="fsz-16"> <?php echo date('d/m/Y', strtotime($order['NgayBatDau'])); ?> </b> </div>
                                            </td>
                                            <td>
                                                <div class="prod-btns fontbold-2">
                                                    <b class="fsz-16"> <?php echo $order['SoLuongNguoi']; ?> </b>
                                                </div>
                                            </td>
                                            <td> 
                                                <div class="order-status pt-15"> 
                                                    <span class="label label-<?php echo $order['TrangThai']=='dangcho'?'warning':($order['TrangThai']=='dathanhtoan'?'success':($order['TrangThai']=='dahuy'?'danger':'default')); ?>">
                                                        <?php 
                                                            if($order['TrangThai']=='dangcho') echo 'Chờ thanh toán';
                                                            elseif($order['TrangThai']=='dathanhtoan') echo 'Đã thanh toán';
                                                            elseif($order['TrangThai']=='dahuy') echo 'Đã hủy';
                                                            else echo htmlspecialchars($order['TrangThai']);
                                                        ?>
                                                    </span>
                                                    <?php if ($order['TrangThai']=='dangcho'): ?>
                                                        <a href="cancel-order.php?id=<?php echo $order['MaDonHang']; ?>" class="theme-btn" onclick="return confirm('Bạn chắc chắn muốn hủy đơn này?');">Hủy đơn</a>
                                                    <?php endif; ?>
                                                </div>
                                            </td>                                       
                                        </tr>  
                                ...
                                <div class="continue-shopping text-center">
                                    <a href="my-account.html" class="theme-btn btn"> Back to account </a>
                                </div>
